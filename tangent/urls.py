...
urlpatterns = patterns('tangent.views',
    ...
    url(r'^organizations/positions/(?P<org_id>\d+)/$', 'org_attach_positions', name='tangent_org_atttach_positions'),
    url(r'^clubs/positions/(?P<org_id>\d+)/$', 'club_attach_positions', name='tangent_club_attach_positions'),
    url(r'^clubs/members/(?P<org_id>\d+)/society$', 'club_society_members', name='tangent_club_society_members'),
